...
CREATE TABLE public.bookings (
    ...
    consignor_charge character varying(255) NOT NULL,
...
--
-- Name: bookings_manifest_id_seq; Type: SEQUENCE; Schema: public; Owner: test
--

CREATE SEQUENCE public.bookings_manifest_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.bookings_manifest_id_seq OWNER TO test;

--
-- Name: bookings_manifest_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: test
--

ALTER SEQUENCE public.bookings_manifest_id_seq OWNED BY public.bookings.manifest_id;
...
--
-- Name: bookings manifest_id; Type: DEFAULT; Schema: public; Owner: test
--

ALTER TABLE ONLY public.bookings ALTER COLUMN manifest_id SET DEFAULT nextval('public.bookings_manifest_id_seq'::regclass);
...
1	1	11111	1	2025-03-24 15:04:34.820096	1	2025-03-24 15:04:34.820096	t
...
--
-- Name: bookings_manifest_id_seq; Type: SEQUENCE SET; Schema: public; Owner: test
--

SELECT pg_catalog.setval('public.bookings_manifest_id_seq', 1, false);
...
--
-- Name: bookings bookings_manifest_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: test
--

ALTER TABLE ONLY public.bookings
    ADD CONSTRAINT bookings_manifest_id_fkey FOREIGN KEY (manifest_id) REFERENCES public.manifests(manifest_id) ON DELETE SET NULL;
